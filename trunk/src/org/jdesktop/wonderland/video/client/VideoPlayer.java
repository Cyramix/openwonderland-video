...
public interface VideoPlayer {
    ...
    /**
     * Determine if the player can seek
     * @return true if the player can seek, or false if not
     */
    public boolean isSeekEnabled();
    
    /**
     * Rewind the video. Only valid if isSeekEnabled() returns true.
     * @param offset the time in seconds to skip back
     */
    public void rewind(double offset);

    /**
     * Skip forward the video. Only valid if isSeekEnabled() returns true.
     * @param offset the time in seconds to skip forward
     */
    public void forward(double offset);

    /**
     * Set the position within the media. Only valid if isSeekEnabled() returns true.
    ...
    /**
     * Gets the duration of the media. Only valid if isSeekEnabled() returns true.
